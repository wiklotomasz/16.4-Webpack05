...
var _TodoList = __webpack_require__(31);
...
var App = function (_React$Component) {
    ...
    _createClass(App, [{
        ...
        value: function addTodo(val) {
            // dodawanie elementow do kolekcji / wartosc (val)
            var todo = { // obiekt todo 
                text: val,
                id: uuid.v4()
            };
            var data = [].concat(_toConsumableArray(this.state.data), [todo]); // operator spread, trzy kropki tworzą nową tablica z 'todo' na koncu. 
            this.setState({ data: data }); // == {data : data}     // stare data to nowe data + todo
        }
